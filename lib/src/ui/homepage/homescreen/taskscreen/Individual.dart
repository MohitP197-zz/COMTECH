...
class _IndividualsState extends State<Individuals> {
  ...
  Text _taskStatus(AssignedTask assignedTask) {
    if (assignedTask.status == 0) {
      return Text("Not-Started", style: TextStyle(color: Colors.redAccent));
    } else if (assignedTask.status == 1) {
      return Text("Not-Started", style: TextStyle(color: Colors.redAccent));
    } else if (assignedTask.status == 2) {
      return Text("Not-Started", style: TextStyle(color: Colors.redAccent));
    }
  }
}
